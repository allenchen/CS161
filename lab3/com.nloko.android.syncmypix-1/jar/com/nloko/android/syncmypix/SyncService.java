...
//            SyncMyPixPreferences, SyncProgressActivity, SyncServiceListener, SyncWakeLock, 
//            SyncMyPixDbHelper, SocialNetworkUser, PhoneContact, SyncResultsActivity
...
public abstract class SyncService extends Service
{
    public static class LocalBinder extends Binder
    {
        ...
        public LocalBinder(SyncService syncservice)
        {
    ...
    private static class SyncTask extends AsyncTask
    {
        ...
        private void addResult(ContentValues contentvalues)
        {
            ...
            if(syncservice == null)
                return;
            boolean flag;
            synchronized(syncservice.mResultsList)
            {
                flag = syncservice.mResultsList.add(contentvalues);
            }
        }
...
label0:
            {
                ...
                contentvalues = synctask.createResult(s5, socialnetworkuser1);
                if(socialnetworkuser.picUrl == null)
                {
                    int i = mNotFound + 1;
                    mNotFound = i;
                    String s6 = syncservice.getString(0x7f060058);
                    ContentValues contentvalues1 = contentvalues;
                    String s7 = "description";
                    String s8 = s6;
                    contentvalues1.put(s7, s8);
                    SyncTask synctask1 = this;
                    ContentValues contentvalues2 = contentvalues;
                    synctask1.addResult(contentvalues2);
                    return;
                }
                s9 = null;
                s10 = null;
                ...
                if(phonecontact != null)
                {
                    ...
                    String s17 = s11;
                    if(contactutils2.isContactUpdatable(contentresolver2, s17) || syncservice.mOverrideReadOnlyCheck)
                        break label0;
                }
                Log.d("SyncService", "Contact not found in database.");
                int j = mNotFound + 1;
                mNotFound = j;
                String s18 = syncservice.getString(0x7f060050);
                ...
                synctask2.addResult(contentvalues4);
                return;
            }
            ...
            SyncMyPixDbHelper.DBHashes dbhashes;
            InputStream inputstream;
            boolean flag1;
            dbhashes = dbHelper.getHashes(s9);
            ...
            String s25 = dbhashes.updatedHash;
            boolean flag = syncservice.mSkipIfExists;
...
_L3:
            String s30;
            String s31;
            String s29 = dbhashes.networkHash;
            s30 = s23;
            s31 = s29;
...
_L5:
            ...
            boolean flag3 = syncservice.mAllowGoogleSync;
            ...
            String s38 = syncservice.getSocialNetworkName();
            ...
            mUpdated = j1;
_L10:
            MainHandler mainhandler = syncservice.mMainHandler;
            if(mainhandler == null) goto _L8; else goto _L7
_L7:
            SyncTask synctask3 = this;
            final SocialNetworkUser user = socialnetworkuser;
            Runnable runnable = synctask3. syncservice. new Runnable() {
...
// JavaClassFileOutputException: Invalid index accessing method local variables table of <init>
            ...
            MainHandler mainhandler1 = mainhandler;
            Runnable runnable1 = runnable;
            boolean flag5 = mainhandler1.post(runnable1);
_L11:
...
_L12:
            SyncTask synctask4 = this;
            ContentValues contentvalues8 = valuesCopy;
            synctask4.addResult(contentvalues8);
            if(inputstream == null)
                return;
            try
            {
            ...
            exception1;
            String s44 = syncservice.getString(0x7f060057);
            valuesCopy.put("description", s44);
            SyncTask synctask5 = this;
            ContentValues contentvalues9 = valuesCopy;
            synctask5.addResult(contentvalues9);
            if(inputstream == null)
                return;
            try
            {
...
_L6:
            int k1 = mSkipped + 1;
            mSkipped = k1;
            String s45 = syncservice.getString(0x7f060054);
            valuesCopy.put("description", s45);
              goto _L10
            Exception exception2;
            exception2;
            SyncTask synctask6 = this;
            ContentValues contentvalues10 = valuesCopy;
            synctask6.addResult(contentvalues10);
            String s46;
            int l1;
            String s47;
            if(inputstream != null)
...
_L8:
            bitmap.recycle();
              goto _L11
_L2:
            s46 = syncservice.getString(0x7f060056);
            valuesCopy.put("description", s46);
              goto _L12
            l1 = mSkipped + 1;
            mSkipped = l1;
            s47 = syncservice.getString(0x7f060052);
...
_L7:
            ...
            int i;
            int j;
            Context context = syncservice.getApplicationContext();
...
_L9:
            ...
            Uri uri3 = uri2;
            synctask.processUser(socialnetworkuser1, phonecontact3, uri3);
            ...
            synctask1.publishProgress(ainteger1);
            if(!syncservice.mCancel) goto _L6; else goto _L5
_L5:
            if(mainhandler != null)
            {
                MainHandler mainhandler1 = mainhandler;
                ...
                int k2 = 0x7f06004b;
                int l2 = 0;
                android.os.Message message = mainhandler1.obtainMessage(j2, k2, l2);
                MainHandler mainhandler2 = mainhandler;
                android.os.Message message1 = message;
                boolean flag2 = mainhandler2.sendMessage(message1);
            }
_L15:
            contentvalues.clear();
            ...
            Runnable runnable = mainhandler.resetExecuting;
            MainHandler mainhandler3 = mainhandler;
            Runnable runnable1 = runnable;
            boolean flag3 = mainhandler3.post(runnable1);
_L11:
            obj;
...
_L2:
            phonecontact2 = phonecontact1;
              goto _L9
_L6:
            int j3 = syncservice.mResultsList.size();
            j3 = 100;
            if(j3 == j3)
            {
                SyncService syncservice1 = syncservice;
                boolean flag4 = false;
                syncservice1.updateResults(flag4);
            }
            i1--;
            j1 = i;
              goto _L10
...
_L14:
            ...
            MainHandler mainhandler4 = mainhandler;
            int k3 = 1;
            int l3 = 0x7f06004e;
            int i4 = 0;
            android.os.Message message2 = mainhandler4.obtainMessage(k3, l3, i4);
            MainHandler mainhandler5 = mainhandler;
            android.os.Message message3 = message2;
            boolean flag5 = mainhandler5.sendMessage(message3);
            if(namematcher == null)
            ...
            if(mCache != null)
                mCache.releaseResources();
            Runnable runnable2 = mainhandler.resetExecuting;
            MainHandler mainhandler6 = mainhandler;
            Runnable runnable3 = runnable2;
            boolean flag6 = mainhandler6.post(runnable3);
              goto _L11
            Exception exception2;
            exception2;
            obj;
...
_L13:
            ...
            if(mCache != null)
                mCache.releaseResources();
            Runnable runnable4 = mainhandler.resetExecuting;
            MainHandler mainhandler7 = mainhandler;
            Runnable runnable5 = runnable4;
            boolean flag7 = mainhandler7.post(runnable5);
            throw exception;
            exception;
            int j4 = j1;
...
_L12:
        ...
        protected void onPostExecute(Long long1)
        {
            ...
            if(syncservice == null)
                return;
            if(long1.longValue() > 0L && !syncservice.mCancel)
            {
                Context context = syncservice.getApplicationContext();
                ...
                syncservice.cancelNotification(0x7f060048, 0x7f060049);
                syncservice.showNotification(0x7f060049, 0x1080082, intent, true);
            } else
            {
                syncservice.cancelNotification(0x7f060048);
            }
            syncservice.updateResults(true);
        }
        ...
        public SyncTask(SyncService syncservice)
        {
            ...
            WeakReference weakreference = new WeakReference(syncservice);
            mService = weakreference;
            Context context1 = ((SyncService)mService.get()).getApplicationContext();
...
label0:
            ...
            {
                MainHandler mainhandler = syncservice.mMainHandler;
                Runnable runnable = syncservice.mMainHandler.finish;
                boolean flag = mainhandler.post(runnable);
                return;
            }
        }
        ...
        public UpdateResultsTable(SyncService syncservice, List list1)
        {
            this(syncservice, list1, true);
        }

        public UpdateResultsTable(SyncService syncservice, List list1, boolean flag)
        {
            WeakReference weakreference = new WeakReference(syncservice);
            mService = weakreference;
            list = list1;
    ...
    public static final class SyncServiceStatus extends Enum
    {

        public static SyncServiceStatus valueOf(String s)
        {
            return (SyncServiceStatus)Enum.valueOf(com/nloko/android/syncmypix/SyncService$SyncServiceStatus, s);
        }

        public static SyncServiceStatus[] values()
        {
            return (SyncServiceStatus[])$VALUES.clone();
        }

        private static final SyncServiceStatus $VALUES[];
        public static final SyncServiceStatus GETTING_FRIENDS;
        public static final SyncServiceStatus IDLE;
        public static final SyncServiceStatus SYNCING;

        static 
        {
            IDLE = new SyncServiceStatus("IDLE", 0);
            GETTING_FRIENDS = new SyncServiceStatus("GETTING_FRIENDS", 1);
            SYNCING = new SyncServiceStatus("SYNCING", 2);
            SyncServiceStatus asyncservicestatus[] = new SyncServiceStatus[3];
            SyncServiceStatus syncservicestatus = IDLE;
            asyncservicestatus[0] = syncservicestatus;
            SyncServiceStatus syncservicestatus1 = GETTING_FRIENDS;
            asyncservicestatus[1] = syncservicestatus1;
            SyncServiceStatus syncservicestatus2 = SYNCING;
            asyncservicestatus[2] = syncservicestatus2;
            $VALUES = asyncservicestatus;
        }

        private SyncServiceStatus(String s, int i)
        {
            super(s, i);
        }
    }
    ...
    private void cancelNotification(int i, int j)
    {
        if(mStarted)
        ...
        {
            Toast.makeText(getApplicationContext(), j, 0).show();
            return;
        }
    }

    public static void cancelSchedule(Context context, Class class1)
    {
    ...
    private void getPreferences()
    {
        ...
        boolean flag = syncmypixpreferences.getAllowGoogleSync();
        mAllowGoogleSync = flag;
        boolean flag1 = syncmypixpreferences.getSkipIfConflict();
        mSkipIfConflict = flag1;
        boolean flag2 = syncmypixpreferences.getMaxQuality();
        mMaxQuality = flag2;
        boolean flag3 = syncmypixpreferences.getCropSquare();
        mCropSquare = flag3;
        boolean flag4 = syncmypixpreferences.getSkipIfExists();
        mSkipIfExists = flag4;
        boolean flag5 = syncmypixpreferences.overrideReadOnlyCheck();
        mOverrideReadOnlyCheck = flag5;
        boolean flag6 = syncmypixpreferences.getIntelliMatch();
        mIntelliMatch = flag6;
        boolean flag7 = syncmypixpreferences.getPhoneOnly();
        mPhoneOnly = flag7;
        boolean flag8 = syncmypixpreferences.getCache();
        mCacheOn = flag8;
        StringBuilder stringbuilder = (new StringBuilder()).append("PhoneOnly is ");
        boolean flag9 = mPhoneOnly;
        String s = stringbuilder.append(flag9).toString();
        Log.d("SyncService", s);
    }
    ...
    {
        cancelNotification(0x7f060048, i);
    }

    private void showNotification(int i, int j)
    {
        showNotification(i, j, false);
    }

    private void showNotification(int i, int j, Intent intent, boolean flag)
    {
        CharSequence charsequence = getText(i);
        long l = System.currentTimeMillis();
        Notification notification = new Notification(j, charsequence, l);
        if(flag)
            notification.flags = 16;
        PendingIntent pendingintent = PendingIntent.getActivity(this, 0, intent, 0);
        CharSequence charsequence1 = getText(i);
        notification.setLatestEventInfo(this, charsequence1, charsequence, pendingintent);
        mNotifyManager.notify(i, notification);
    }

    private void showNotification(int i, int j, boolean flag)
    {
        Context context = getApplicationContext();
        Intent intent = new Intent(context, com/nloko/android/syncmypix/SyncProgressActivity);
        Intent intent1 = intent.addFlags(0x20020000);
        showNotification(i, j, intent, flag);
    }

    private void updateResults(boolean flag)
    {
        ...
        {
            List list = mResultsList;
            (new UpdateResultsTable(this, list, flag)).start();
            return;
        }
    }

    public static void updateSchedule(Context context, Class class1, long l, long l1)
    {
        if(context == null)
        {
        ...
        {
            Intent intent = new Intent("com.nloko.android.syncmypix.SYNC");
            PendingIntent pendingintent = PendingIntent.getBroadcast(context, 0, intent, 0);
            AlarmManager alarmmanager = (AlarmManager)context.getSystemService("alarm");
            long l2 = l;
            long l3 = l1;
            alarmmanager.setRepeating(0, l2, l3, pendingintent);
            return;
        }
    }
    ...
    public void cancelOperation()
    {
        if(!mExecuting)
            return;
        SyncServiceListener syncservicelistener = mListener;
        if(syncservicelistener != null)
            syncservicelistener.onSyncCancelled();
        mCancel = true;
    }
    ...
    public void onStart(Intent intent, int i)
    {
        ...
        mNotifyManager.cancel(0x7f060049);
        showNotification(0x7f060048, 0x1080081);
    }

    public void setListener(SyncServiceListener syncservicelistener)
    {
        if(syncservicelistener == null)
        {
    ...
    public static final int GETTING_FRIENDS = 1;
    ...
    private final List mResultsList;
...
/*
    static boolean access$102(SyncService syncservice, boolean flag)
    {
        syncservice.mExecuting = flag;
        return flag;
    }
...
/*
    static SyncTask access$402(SyncService syncservice, SyncTask synctask)
    {
        syncservice.mSyncOperation = synctask;
        return synctask;
    }
